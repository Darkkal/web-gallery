...
const globalForQueue = globalThis as unknown as {
  avatarRequestQueue: RequestQueue;
};

export const avatarRequestQueue =
  globalForQueue.avatarRequestQueue || new RequestQueue();

if (process.env.NODE_ENV !== "production")
  globalForQueue.avatarRequestQueue = avatarRequestQueue;
