...
* **api:** add post-ids and post media API routes for dynamic playlists ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **db:** add getPostMediaItems and update getMediaItems to fetch first item per post ([b7f224b](https://github.com/Darkkal/web-gallery/commit/b7f224bdaa273f80fbdcf9f42bd50962f8e2fbf3))
* **db:** add type and searchQuery columns to playlists table schema and migration ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **gallery:** add server action and route handler for fetching post media items ([b7f224b](https://github.com/Darkkal/web-gallery/commit/b7f224bdaa273f80fbdcf9f42bd50962f8e2fbf3))
* **gallery:** handle dynamic playlist filtering in gallery and AddToPlaylistModal ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
...
* **lightbox:** implement lazy loading of post media items in gallery lightbox ([b7f224b](https://github.com/Darkkal/web-gallery/commit/b7f224bdaa273f80fbdcf9f42bd50962f8e2fbf3))
...
* **media:** add post-based query helpers and update dynamic playlists repository ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **player:** implement two-level post and media navigation model ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **playlists:** add search autocomplete to saved search query in CreatePlaylistModal ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **playlists:** clarify normal vs dynamic playlist types in creation modal ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **playlists:** display post count and post rows for dynamic playlists ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **playlists:** update CreatePlaylistModal to support dynamic playlist creation and editing ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
* **playlists:** update server actions and API routes for dynamic playlists ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
...
* **types:** add PlaylistPost interface for post-based dynamic playlists ([4f13fe3](https://github.com/Darkkal/web-gallery/commit/4f13fe37fb5c1387d8c48696a35319fb209d50af))
...
* **scheduler:** make addSchedule async and await updateNextRunAt ([485848d](https://github.com/Darkkal/web-gallery/commit/485848d09944d63918e76c002384fa8ea4437cbc))
* **scrape:** decouple onChange reference in ScheduleBuilder effect ([485848d](https://github.com/Darkkal/web-gallery/commit/485848d09944d63918e76c002384fa8ea4437cbc))
* **scrape:** prevent ScheduleBuilder prop re-parsing feedback loop and fix schedule saving ([485848d](https://github.com/Darkkal/web-gallery/commit/485848d09944d63918e76c002384fa8ea4437cbc))
